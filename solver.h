...
// the constant READ_FAIL is returned by read_int() when:
...
// the constant INVALID_CHAR is returned by read_char when:
...
//   (which may or may not ignore_ws [whitespace]) or INVALID_CHAR
// effects: reads from input
